...
export async function buscarConta (navigate) {
...
export async function buscarPessoais (navigate) {
    const token = getToken();
...
export async function editarEmail (email, navigate) {
    try {
        const token = getToken();
...
export async function editarSenha (senhaAtual, novaSenha, confirmaSenha, navigate) {
    try {
        const token = getToken();
...
export async function editarDadosPessoais (nome, cpf, genero, dataNascimento, telefone) {
    try {
        const token = getToken();
